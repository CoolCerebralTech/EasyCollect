  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans antialiased">
      ...
      <div className="bg-white border-b border-slate-200 relative overflow-hidden">
        {/* Layered gradient mesh — soft, modern, no hard blobs */}
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          <div className="absolute -top-32 -right-24 w-[34rem] h-[34rem] bg-gradient-to-br from-emerald-100 via-teal-50 to-transparent rounded-full blur-3xl opacity-70"></div>
          <div className="absolute top-40 -left-32 w-[28rem] h-[28rem] bg-gradient-to-tr from-lime-100 via-emerald-50 to-transparent rounded-full blur-3xl opacity-60"></div>
        </div>

        <div className="max-w-6xl mx-auto px-4 pt-14 pb-20 sm:pt-20 sm:pb-24 relative">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            
            {/* Left: Text & CTA */}
            <div className="text-left z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-200/60 text-emerald-800 text-xs sm:text-sm font-semibold mb-5 sm:mb-6">
                <span aria-hidden>🇰🇪</span>
                <span>Simple. Secure. Kenyan.</span>
              </div>
              
              <h1 className="text-4xl sm:text-5xl lg:text-[3.75rem] font-extrabold text-slate-900 tracking-tight mb-5 sm:mb-6 leading-[1.05]">
                Track <span className="bg-gradient-to-r from-emerald-600 to-teal-500 bg-clip-text text-transparent">Chama Money</span> without the chaos.
              </h1>
              
              <p className="text-base sm:text-lg text-slate-600 mb-7 sm:mb-9 leading-relaxed max-w-lg">
                Stop scrolling through WhatsApp to find M-Pesa messages. Create a <strong className="font-semibold text-slate-800">shared link</strong> where everyone can see who has paid and who is pending.
              </p>
              ...
              {/* Trust Statement */}
              <div className="mt-7 sm:mt-9 flex flex-wrap items-center gap-x-4 gap-y-2 text-xs sm:text-sm text-slate-500">
                <span className="flex items-center gap-1.5">
                  <span className="text-emerald-500">🛡️</span> No bank login needed
                </span>
                <span className="w-1 h-1 bg-slate-300 rounded-full"></span>
                <span className="flex items-center gap-1.5">
                  <span className="text-emerald-500">🔒</span> Money stays in M-Pesa
                </span>
              </div>
            </div>
            ...
            <div className="relative z-10 hidden lg:block">
              <div className="relative mx-auto border-slate-900 bg-slate-900 border-[14px] rounded-[2.5rem] h-[500px] w-[280px] shadow-2xl shadow-emerald-900/20">
                ...
                <div className="rounded-[2rem] overflow-hidden w-full h-full bg-white flex flex-col">
                  {/* Mockup Header */}
                  <div className="bg-gradient-to-br from-emerald-600 to-teal-600 p-4 text-white pt-8">
                  ...
                  <div className="p-4 space-y-3 bg-slate-50 flex-1">
                    <div className="flex justify-between items-center p-3 bg-white rounded-xl shadow-sm border-l-4 border-emerald-500">
                      <div className="text-xs">
                        <div className="font-bold text-slate-800">John Kamau</div>
                        <div className="text-slate-400">Paid today</div>
                      </div>
                      <div className="font-bold text-emerald-600">+1,000</div>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-white rounded-xl shadow-sm border-l-4 border-emerald-500">
                      <div className="text-xs">
                      ...
                      <div className="font-bold text-emerald-600">+5,000</div>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-white rounded-xl shadow-sm border-l-4 border-slate-200 opacity-60">
                      <div className="text-xs">
                  ...
                  <div className="absolute bottom-6 right-6 w-12 h-12 bg-emerald-600 rounded-full flex items-center justify-center shadow-lg text-white text-2xl font-bold">+</div>
                </div>
              </div>
              
              {/* Floating Badge on Mockup */}
              <div className="absolute top-20 -left-12 bg-white p-3 rounded-xl shadow-xl border border-emerald-100 flex items-center gap-3 animate-bounce">
      ...
      {/* 5. FINAL CTA */}
      <div className="bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-700 py-20 text-center px-4 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none" aria-hidden>
          <div className="absolute -top-20 left-1/4 w-72 h-72 bg-white rounded-full blur-3xl"></div>
          <div className="absolute -bottom-20 right-1/4 w-72 h-72 bg-lime-200 rounded-full blur-3xl"></div>
        </div>
        <div className="relative">
          ...
          <p className="mt-4 text-sm text-emerald-100/80">Free to use. No hidden fees.</p>
        </div>
      </div>
